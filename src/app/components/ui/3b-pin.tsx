...
// Type for the PinContainer props
interface PinContainerProps {
  children: React.ReactNode;        // children prop will be of type React.ReactNode
  title: string;                    // title should be a string
  href?: string;                    // href is optional, type string
  className?: string;               // className is optional, type string
  containerClassName?: string;      // containerClassName is optional, type string
}
...
export const PinPerspective: React.FC<PinPerspectiveProps> = ({ title }) => {
    return (
        ...
        <div className="w-full h-full -mt-7 flex-none relative inset-0">
