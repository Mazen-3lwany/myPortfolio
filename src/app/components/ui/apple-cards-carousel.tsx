...
// Define types for the items passed to the Carousel
...
// Define types for the BlurImage props
import { ImageProps } from 'next/image'; // Import the type for the Image component


interface BlurImageProps extends ImageProps {
  fill?: boolean; // Add 'fill' as an optional boolean prop
}

export const BlurImage = ({
  src,
  alt,
  fill = false,  // Default value for fill
  className,
  ...rest
}: BlurImageProps) => {
  ...
  return (
    <Image
      ...
      src={src}
      alt={alt}
      layout={fill ? 'fill' : 'intrinsic'} // Handle layout as 'fill' if fill is true
      loading="lazy"
      decoding="async"
      {...rest}
    />
